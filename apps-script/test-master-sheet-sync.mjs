...
assert.match(source, /Új soron kitöltött oszlopok/);
assert.match(source, /Meglévő soron írható oszlopok/);
assert.match(source, /Csak üres munkatársi cellába írható/);
assert.match(source, /Csak a munkatársi lapon szereplő, érintetlenül hagyott ID-k/);
